    ...
    <>
      ...
      <article className='container mx-auto my-5'>
        ...
        <p>
          ...
          <br />
          Danil Trapeznikov 47/602 I house laguna RCA, Pra Ram 9, Bangkok
          <br />
          Owner contact email: thousandsofraccoons@gmail.com
        </p>
        ...
        <p>
          ...
          Personal Data obtained, published or shared through this Application
          and confirm that they have the third party's consent to provide the
          Data to the Owner.
        </p>
        ...
        <p>
          ...
          activity, as well as the following: Content commenting.
        </p>
        <p>
        ...
        <p>
          ...
          following services: <strong>Content commenting</strong>
        </p>
        <p>
          Content commenting services allow Users to make and publish their
          comments on the contents of this Application. Depending on the
          settings chosen by the Owner, Users may also leave anonymous comments.
          If there is an email address among the Personal Data provided by the
          User, it may be used to send notifications of comments on the same
          content. Users are responsible for the content of their own comments.
        ...
        <p>
          <strong>Facebook Comments (Facebook, Inc.)</strong>
        </p>
        <p>
        ...
        <time>Latest update: {String(new Date())}</time>
      </article>
      <Footer />
    </>
  )
